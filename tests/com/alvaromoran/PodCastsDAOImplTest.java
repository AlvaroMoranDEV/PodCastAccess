...
public class PodCastsDAOImplTest {
    ...
    private static final String GENERIC_SEARCH_TERM_2 = "historia";
    private static final String VALID_SEARCH_ARTIST = "Onda Cero";
    private static final String VALID_SEARCH_AUTHOR = "OndaCero";
    private static final String CHANNEL_URL_1 = "http://itunes.uned.es/000104/figuras_historia/figuras_historia.xml";
    private static final String CHANNEL_URL_2 = "http://www.ondacero.es/rss/podcast/8502/podcast.xml";
    ...
    void updateTermSearchParameterNull() {
        ...
        try {
            List<PodCastChannelDTO> returnedValue = this.podCastsDAOImpl.updateTermSearchParameter(null);
        } catch (Exception e) {
            returnedException = e;
        }
    ...
    void updateTermSearchParameterEmpty() {
        Exception returnedException = null;
        try {
            List<PodCastChannelDTO> returnedValue = this.podCastsDAOImpl.updateTermSearchParameter("");
        } catch (Exception e) {
            returnedException = e;
        }
        assertNotNull(returnedException);
    ...
    void getListOfEpisodesFromNullChannel() {
        ...
        try {
            List<PodCastChannelDTO> returnedValue = this.podCastsDAOImpl.executeQueryOnDemand();
            if (returnedValue.size() > 0) {
                PodCastChannelDTO channel = this.podCastsDAOImpl.getListOfEpisodesFromChannel(null);
            }
        } catch (Exception e) {
            returnedException = e;
        }
